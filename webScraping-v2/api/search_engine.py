...
# Directorio base de webScraping-v2
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
DATADIR = os.path.join(BASE_DIR, "data")

# Posibles ubicaciones de embeddings y datos dentro de webScraping-v2 o carpeta superior
EMBEDDING_PATHS = [
    os.path.join(DATADIR, "embeddings.npy"),
    os.path.join(DATADIR, "index_embeddings.npy"),
    os.path.abspath(os.path.join(BASE_DIR, "..", "data", "embeddings.npy")),
    os.path.abspath(os.path.join(BASE_DIR, "..", "data", "index_embeddings.npy")),
]

IDSPATH = os.path.join(DATADIR, "ids.npy")
CONECTOR_PATH = os.path.join(BASE_DIR, "conector_sala3.py")
